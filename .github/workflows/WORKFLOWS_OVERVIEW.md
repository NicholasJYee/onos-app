...
- Artifacts prefixed with `onos-test-`
...
```
onos-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `onos-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `onos-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `onos-macos-aarch64-release-0.1.3`
