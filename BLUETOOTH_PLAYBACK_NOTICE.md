...
When **reviewing recordings** in ONOS, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **ONOS records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing ONOS recordings** - Use wired/speakers instead
...
### This is Not a ONOS Bug

The issue is in **macOS's Bluetooth audio stack**, not in ONOS's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a ONOS bug. We've correctly recorded at 48kHz.
...
**A**: Yes! ONOS now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: ONOS v0.0.5+ on macOS
