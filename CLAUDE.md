...
**ONOS** is a privacy-first AI meeting assistant that captures, transcribes, and summarizes meetings entirely on local infrastructure. The project consists of two main components:
...
- **Production (macOS)**: `~/Library/Application Support/ONOS/models/`
- **Production (Windows)**: `%APPDATA%\ONOS\models\`
