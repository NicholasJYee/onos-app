...
This guide provides detailed instructions for building ONOS from source on different operating systems.
...
This guide helps you build ONOS on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/ONOS_<version>_amd64.AppImage
```
